(function () {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                if (!xhr.responseXML) {
                    ...
                    if (grid) grid.innerHTML = "<div style='padding:20px; color:red;'>Error: apps.xml is invalid. Please check your XML syntax.</div>";
                    return;
                }
                // --------------------
    ...
    function processApps(xml) {
        ...
        for (var i = 0; i < apps.length; i++) {
            var appNode = apps[i];
            // Ensure these tags exist before accessing them
