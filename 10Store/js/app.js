(function () {
    ...
    function renderApp(app) {
        ...
        var html =
            '<div class="app-hero">' +
            '<img class="hero-bg" src="' + icon + '" alt="">' +
            ...
            '</div>' +
            '</div>' +
            '<section class="app-section" aria-label="Description" style="margin: 0px auto; max-width: 980px;"><h2 class="section-title">Description</h2>' + desc + '</section>' +
            '<section class="app-section" aria-label="Screenshots">' +
