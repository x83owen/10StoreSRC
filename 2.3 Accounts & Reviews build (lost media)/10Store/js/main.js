(function () {
    ...
    WinJS.UI.processAll().then(function () {
        ...
        function checkPersistentLogin() {
            ...
            // 2. Background Verification: Check if the account still exists on GitHub
            var timestamp = new Date().getTime();
            var githubUrl = "https://api.github.com/repos/" + GITHUB_OWNER + "/" + GITHUB_REPO + "/contents/accounts.xml?t=" + timestamp;
            ...
            WinJS.xhr({
                ...
                try {
                    ...
                    // IE-Safe Base64 Decode: Remove any whitespace/newlines GitHub might add
        ...
        function updateMenuForLoggedInState() {
            ...
            if (btnDelete) {
                ...
                btnDelete.onclick = function () {
                    // Get the current user's email to know who to delete
                    var userEmail = localSettings.values["userEmail"];

                    // POINT THIS TO YOUR NETLIFY PAGE
        ...
        function logOut() {
            ...
            location.reload(); // Refresh to reset UI state easily
        }
