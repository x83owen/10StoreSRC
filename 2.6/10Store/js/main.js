(function () {
    ...
    WinJS.UI.processAll().then(function () {
        ...
        function loadPlaylist() {
            return WinJS.xhr({
                url: "https://draydenthemiiyt-maker.github.io/draymusic.github.io/music.xml",
                ...
                try {
                    ...
                    var tracks = doc.getElementsByTagName("song");
        ...
        loadPlaylist().then(function (list) {
            playlist = list;

            if (playlist.length > 0) {
                currentIndex = 0;
                loadCurrentTrack(); // loads metadata but does NOT autoplay
            }
        });
        ...
        function loadAppsForLiveTile() {
            WinJS.xhr({
                url: "https://10storedraydenyt.vercel.app/apps.xml",
                headers: { "Cache-Control": "no-cache" }
            }).done(function (res) {
                try {
