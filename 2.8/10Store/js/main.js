(function () {
    ...
    var platformSuffix = "?WindowsPhone=0";
    try {
        if (typeof Windows !== "undefined") {
            var deviceFamily = Windows.System.Profile.AnalyticsInfo.versionInfo.deviceFamily;
            if (deviceFamily === "Windows.Mobile") {
                platformSuffix = "?WindowsPhone=1";
            }
        }
    } catch (e) {
        console.warn("Device detection failed, defaulting to Desktop.");
    }
    ...
    WinJS.UI.processAll().then(function () {
        ...
        function navigateWithAnimation(url) {
            ...
            if (wrapper && frame) {
                ...
                var finalUrl = url + platformSuffix;
                frame.navigate(finalUrl);
            }
        }
            ...
            frame.addEventListener("MSWebViewNavigationCompleted", function (e) {
                ...
                setTimeout(function () {
                    if (wrapper) {
                        ...
                        WinJS.UI.Animation.enterContent(wrapper);
                    }
                }, 100);
            });
        }
        ...
        var splashScreen = document.getElementById("extended-splash");
        ...
        WinJS.xhr({
            ...
            try {
                ...
                if (quotes && quotes.length > 0) {
                    ...
                    splashText.innerText = quotes[randomIndex].textContent || "Loading";
                    splashText.style.opacity = "1";
                } else {
                    splashText.innerText = "Loading";
    ...
    function updateAccentAndTheme() {
        ...
        try {
            if (typeof Windows !== "undefined" && Windows.UI.ViewManagement.ApplicationView) {
                var titleBar = Windows.UI.ViewManagement.ApplicationView.getForCurrentView().titleBar;

                // Define colors with Alpha (CRITICAL to prevent crash)
                ...
                if (isLight) {
                    ...
                    titleBar.buttonHoverBackgroundColor = { a: 255, r: 230, g: 230, b: 230 };
                } else {
                    // DARK MODE: Black (#000)
                    ...
                    titleBar.buttonHoverBackgroundColor = { a: 255, r: 40, g: 40, b: 40 };
                }

                // Sync Inactive states so it doesn't default to gray when clicking away
                titleBar.inactiveBackgroundColor = titleBar.backgroundColor;
                titleBar.buttonInactiveBackgroundColor = titleBar.buttonBackgroundColor;
            }
        } catch (e) {
            console.warn("Title bar update failed", e);
        }

        try {
            if (typeof Windows !== "undefined" && Windows.UI.ViewManagement.StatusBar) {
                ...
                if (isLight) {
                    ...
                    statusBar.foregroundColor = black;
                } else {
            ...
            console.warn("StatusBar API not supported on this device family.");
        }
    ...
    (function() {
        try {
            ...
            if (document.documentElement) {
                ...
                var styleId = "injected-img-blocker";
                if (!document.getElementById(styleId)) {
                    var style = document.createElement('style');
                    style.id = styleId;
                    style.textContent = "img { pointer-events: none !important; }";
    ...
    `;
            ...
            try {
                ...
                console.warn("Could not inject styles into webview.", err);
            }
        }
    }
